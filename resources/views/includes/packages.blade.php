<div class="col l3">
    <div class="pack-box pack-white" style="height: 500px;">
        <h4>المجانية
            <small>
                الباقة المبسطة<br>
                باقة مجانية بالكامل
...
<div class="col l3">
    <div class="pack-box pack-yellow" style="height: 500px;">
        <h4>الاضافية
            <small>
                الباقة المتوسطة<br>
...
<div class="col l3">
    <div class="pack-box pack-red" style="height: 500px;">
        <h4>المميزة
            <small>
                الباقة الذهبية<br>
...
<div class="col l3">
    <div class="pack-box pack-blue" style="height: 500px;">
        <h4>الكاملة
            <small>
...
<span>ظهور 3 صور مع الاعلان</span>
        <div class="choose-pack">
