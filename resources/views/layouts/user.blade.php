...
<head>
    ...
    <!-- Main Style -->
     ...
     <!-- Search Page style -->
    <link href="{{ asset('front-assets/css/custome.css') }}" rel="stylesheet">
    <!-- End -->
                ...
                <div class="row no-margin">
                    ...
                    <div class="col l4 user-ctrl">
                        ...
                        <a class='dropdown-button butn orange wtc' href='' data-activates='dropdown1'>language</a>
                           ...
                           <ul id='dropdown1' class='dropdown-content'>
                            <li><a class="bc" href="{{Url('lang/ar')}}"><img src="{{ asset('images/ksa.gif')}}" alt=""></a></li>
                            <li><a class="bc" href="{{Url('lang/en')}}"><img src="{{ asset('images/en.jpg')}}" alt=""></a></li>
                             </ul>
                             @else
...
<script defer src="{{Url('/')}}/front-assets/js/searchScript.js"></script>
