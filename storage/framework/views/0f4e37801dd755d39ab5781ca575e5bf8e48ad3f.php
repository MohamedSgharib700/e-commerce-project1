                    ...
                    <div class="col l4 user-ctrl">
                        <div class="account-box">
                            ...
                            <div class="account-drop">
                                <ul>
                                     <?php if(Session::get('lang') == 'en'): ?>
                                    <li><a href="<?php echo e(route ('register')); ?>">Ads Administration</a></li>
                                    <li><a href="<?php echo e(route ('register')); ?>">Messages</a></li>
                                    <li><a href="<?php echo e(route ('register')); ?>">Saved Searches</a></li>
                                    <li><a href="<?php echo e(route ('register')); ?>">Profile personly</a></li>
                        ...
                        <div class="col l4 user-ctrl">
                            <div class="account-box">
                                ...
                                <div class="account-drop">
                                    <ul>
                                        <?php if(Session::get('lang') == 'en'): ?>
                                    <li><a href="<?php echo e(route ('ads')); ?>">Ads Administration</a></li>
                                    <li><a href="<?php echo e(route ('messages')); ?>">Messages</a></li>
                                    <li><a href="<?php echo e(route ('savedsearch')); ?>">Saved Searches</a></li>
                                    <li><a href="<?php echo e(route ('profile')); ?>">Profile personly</a></li>
                            ...
                            <div class="add-ad">
                                <?php if(Session::get('lang') == 'en'): ?>
                                  <a class="butn blue" href="<?php echo e(Url('newad')); ?>">Add advertising</a>
                                <?php else: ?>
...
<?php endif; ?>
<?php echo $__env->yieldContent('shenFooter'); ?>
</body>
</html>
