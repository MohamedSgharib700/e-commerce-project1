<div class="mini-tab-box m25ran active swiped">
    <div class="swiper-container" dir="rtl">
        ...
        <?php $__currentLoopData = $lastseen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- slide start -->
            <?php if($key % 2 == 0): ?>
        ...
        <?php if(count($lastseen) != 0 && count($lastseen) % 2 != 0): ?>
        </div>
        <?php endif; ?>
        </div>
